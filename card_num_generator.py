...
file_name = time.strftime('%Y_%m_%d_') + str(start_num) + '_' + str(end_num) + '_' + \
            str(int(((end_num - start_num + 1)/3) / 1000)) + 'k'
with open(os.path.join('/Users/admin/Documents/python/' + file_name + '.csv'), 'w', newline='') as csvfile:
    ...
    spamwriter.writerow(['Main card code', 'Main card barcode', '1st trinket code', '1st trinker barcode',
      '2nd trinket code', '1nd trinker barcode','3rc trinket code', '3rd trinker barcode'])
